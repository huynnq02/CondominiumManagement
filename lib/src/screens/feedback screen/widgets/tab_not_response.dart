...
class TabNotResponse extends StatefulWidget {
  final List<f.Feedback> feedbacks;

  const TabNotResponse({
    Key? key,
    required this.feedbacks,
  }) : super(key: key);

  @override
  State<TabNotResponse> createState() => _TabNotResponseState();
}

class _TabNotResponseState extends State<TabNotResponse> {
