...
import 'package:untitled/src/screens/dashboard/widget/widget_line_chart%20copy.dart';
                ...
                ? Column(
                    children: [
                      GestureDetector(
                          ...
                          child: Row(children: [
                            Expanded(child: TotalComments(total: average)),
                            Expanded(
                                child:
                                    positiveComments(positive: percentPositive))
                          ])),
                      GestureDetector(
                          onTap: () {
                            setState(() {});
