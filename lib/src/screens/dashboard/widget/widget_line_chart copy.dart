...
class WidgetLineChart2 extends StatefulWidget {
  WidgetLineChart2({
    Key? key,
  }) : super(key: key);

  @override
  State<WidgetLineChart2> createState() => _WidgetLineChartState();
}

class _WidgetLineChartState extends State<WidgetLineChart2> {
